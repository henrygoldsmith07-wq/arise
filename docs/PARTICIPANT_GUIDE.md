...
Everything above stays in the app's local storage. There is **no account, no server, no analytics**. Data leaves your phone only when *you* create an export file and send it to the study team yourself.
