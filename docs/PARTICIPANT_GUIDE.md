# Arise study — participant guide

Thank you for being part of the pilot. This page tells you everything you need to do. **Train normally** — the study observes; it does not coach.
...
- Your readiness check-ins, in structured form only: date, score, sleep, soreness, motivation.
- Rough timing of how long logging takes (part of local measurements).
- Structured session tags you tap (e.g. "felt strong", "pain / discomfort") — never anything you type.

## What stays on your phone

Everything above stays in the app's local storage. There is **no account, no server, no analytics**. Data leaves your phone only when *you* create an export file and send it to the study team yourself. Health-platform connections (steps, heart rate, sleep tracking) are never part of the study export.

## Training during the study

- Train **normally**, as you would without the study.
- Aim for your usual number of sessions each week — there is no study-specific target.
- If a recommendation doesn't feel right, change it; your overrides are honest data, not failure.
...
Open **More** and find the study card to see your current status (joined, active, or withdrawn), what participation means, and your export history.
...
Ask the study team through the channel they gave you. Nothing in this study requires you to share your identity — exports are keyed by a random study ID created when you joined.
