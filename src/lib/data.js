...
export const EXERCISES = [
  ...
  { id: 'band-row', name: 'Banded Row', muscle: 'Back', equipment: ['bands'], level: 'Beginner', tags: ['compound','pull'], cues: ['Hinge slightly','Pull elbows past torso'], substitution: ['dumbbell-row', 'pull-up', 'lat-pulldown', 'face-pull', 'cable-row', 'inverted-row', 'superman', 'rowing'], progression: 'reps' },
  ...
  { id: 'lunge', name: 'Forward Lunge', muscle: 'Legs', equipment: ['bodyweight','dumbbells'], level: 'Beginner', tags: ['compound','unilateral'], cues: ['Front knee over ankle','Torso upright'], substitution: ['split-squat', 'bulgarian-split-squat', 'step-up', 'bodyweight-squat', 'wall-sit'], unilateral: true, supportsWeighted: true, progression: 'reps', rom: true },
  ...
  { id: 'wall-sit', name: 'Wall Sit', muscle: 'Legs', equipment: ['bodyweight'], level: 'Beginner', tags: ['low-impact'], cues: ['Thighs parallel to floor','Back flat on the wall','Breathe through the burn'], substitution: ['plank', 'bodyweight-squat','jump-squat','pistol-squat','assisted-pistol-squat','shrimp-squat','cossack-squat','sissy-squat','lateral-lunge','skater-squat','standing-quad-stretch','lunge'], unilateral: false, progression: 'time' },
  ...
  { id: 'band-lateral-raise', name: 'Banded Lateral Raise', muscle: 'Shoulders', equipment: ['bands'], level: 'Beginner', tags: ['isolation'], cues: ['Slow tempo'], substitution: ['lateral-raise', 'rear-delt-fly', 'pike-push-up'], progression: 'reps' },
  ...
  { id: 'dumbbell-shrug', name: 'Dumbbell Shrug', muscle: 'Shoulders', equipment: ['dumbbells'], level: 'Beginner', tags: ['isolation','grip'], cues: ['Straight arms','Ears away from shoulders','Pause at the top'], substitution: ['face-pull', 'farmer-carry', 'shrug'], unilateral: false, supportsWeighted: true, progression: 'load' },
  ...
  { id: 'band-curl', name: 'Banded Bicep Curl', muscle: 'Arms', equipment: ['bands'], level: 'Beginner', tags: ['isolation'], cues: ['Step on band','Control up and down'], substitution: ['bicep-curl', 'close-grip-push-up'], progression: 'reps' },
  ...
  { id: 'overhead-tricep-extension', name: 'Overhead Tricep Extension', muscle: 'Arms', equipment: ['dumbbells'], level: 'Beginner', tags: ['isolation','push'], cues: ['Elbows narrow','Deep stretch','Extend fully'], substitution: ['tricep-pushdown', 'skullcrusher','rope-tricep-pushdown', 'close-grip-push-up'], unilateral: false, progression: 'load' },
  ...
  { id: 'kettlebell-swing', name: 'Kettlebell Swing', muscle: 'Full body', equipment: ['kettlebell'], level: 'Intermediate', tags: ['compound','explosive'], cues: ['Hip hinge power','Arms guide, hips drive'], substitution: ['romanian-deadlift', 'farmer-carry', 'thruster', 'burpee'], progression: 'reps' },
  ...
  { id:'superman', name:'Superman Hold', muscle:'Back', equipment:['bodyweight'], level:'Beginner', tags:['core-stability','low-impact'], cues:['Lift chest and thighs','Long neck','Breathe through the hold'], substitution: ['bird-dog','back-extension','band-row'], unilateral:false, progression:'time' },
  { id:'close-grip-push-up', name:'Close-Grip Push-up', muscle:'Arms', equipment:['bodyweight'], level:'Beginner', tags:['compound','push'], cues:['Hands under sternum','Elbows brush ribs','Body rigid'], substitution: ['push-up', 'tricep-dip-bench','band-curl','overhead-tricep-extension','barbell-curl','skullcrusher'], unilateral:false, supportsWeighted:true, progression:'reps', rom:true },
  { id:'cable-goblet-squat', name:'Cable Goblet Squat', muscle:'Legs', equipment:['cable'], level:'Beginner', tags:['compound'], cues:['Hold attachment at chest','Sit between the knees','Drive the floor away'], substitution: ['goblet-squat', 'bodyweight-squat'], unilateral:false, progression:'load', rom:true },
  ...
  { id:'machine-shoulder-press', name:'Machine Shoulder Press', muscle:'Shoulders', equipment:['machine'], level:'Beginner', tags:['compound','push'], cues:['Handles at ear height','Press without shrugging','Control down'], substitution: ['overhead-press-dumbbell','machine-lateral-raise','reverse-pec-deck','machine-dip'], unilateral:false, progression:'load' },
  { id:'reverse-pec-deck', name:'Reverse Pec Deck', muscle:'Shoulders', equipment:['machine'], level:'Beginner', tags:['isolation','pull'], cues:['Arms slightly bent','Lead with pinkies','Squeeze rear delts'], substitution: ['rear-delt-fly', 'face-pull','bent-over-rear-delt-raise', 'machine-shoulder-press'], unilateral:false, progression:'load' },
  { id:'barbell-curl', name: 'Barbell Curl', muscle:'Arms', equipment:['barbell'], level:'Beginner', tags:['isolation'], cues:['Shoulder-width grip','Elbows pinned','No hip drive'], substitution: ['bicep-curl', 'close-grip-push-up'], unilateral:false, progression:'load' },
  ...
  { id:'skullcrusher', name:'Barbell Skullcrusher', muscle:'Arms', equipment:['barbell'], level:'Intermediate', tags:['isolation','push'], cues:['Upper arms vertical','Lower behind the head','Protect the elbows'], substitution: ['tricep-pushdown', 'overhead-tricep-extension', 'close-grip-push-up'], unilateral:false, progression:'load' },
  { id:'machine-dip', name:'Machine Dip', muscle:'Arms', equipment:['machine'], level:'Beginner', tags:['compound','push'], cues:['Slight forward lean','Elbows track back','Full lockout'], substitution: ['tricep-dip-bench', 'tricep-pushdown', 'machine-shoulder-press', 'assisted-dip'], unilateral:false, progression:'load' },
  ...
  { id: 'machine-row', name: 'Machine Row', muscle: 'Back', equipment: ['machine'], level: 'Beginner', tags: ['compound','pull'], imageSlug: 'machine-row', cues: ["Squeeze shoulder blades","Pull with elbows","Control the return"], substitution: ['t-bar-row', 'chest-supported-row', 'barbell-row', 'assisted-pull-up'], unilateral: false, supportsWeighted: /weighted/i.test('machine-row'), supportsAssisted: /assisted/i.test('machine-row'), progression: 'load' },
  ...
  { id: 'assisted-pull-up', name: 'Assisted Pull-up', muscle: 'Back', equipment: ['machine'], level: 'Beginner', tags: ['isolation','pull'], imageSlug: 'assisted-pull-up', cues: ["Initiate from the armpit","Keep torso stable","Full stretch at top"], substitution: ['lat-pulldown', 'machine-row'], unilateral: false, supportsWeighted: /weighted/i.test('assisted-pull-up'), supportsAssisted: /assisted/i.test('assisted-pull-up'), progression: 'reps' },
  ...
  { id: 'shrug', name: 'Barbell Shrug', muscle: 'Back', equipment: ['barbell'], level: 'Intermediate', tags: ['compound','pull'], imageSlug: 'shrug', cues: ["Pinch shoulder blades","Chin tucked","Hold briefly"], substitution: ['face-pull', 'barbell-row', 'dumbbell-shrug'], unilateral: false, supportsWeighted: /weighted/i.test('shrug'), supportsAssisted: /assisted/i.test('shrug'), progression: 'load' },
  ...
  { id: 'assisted-dip', name: 'Assisted Dip', muscle: 'Arms', equipment: ['machine'], level: 'Beginner', tags: ['isolation','push'], imageSlug: 'assisted-dip', cues: ["Elbows narrow","Full extension","Slow negative"], substitution: ['tricep-pushdown', 'machine-dip', 'assisted-dip'], unilateral: false, supportsWeighted: /weighted/i.test('assisted-dip'), supportsAssisted: /assisted/i.test('assisted-dip'), progression: 'reps' },
  ...
  { id: 'rowing', name: 'Rowing', muscle: 'Back', equipment: ['bodyweight'], level: 'Intermediate', tags: ['isolation','pull'], imageSlug: 'rowing', cues: ["Squeeze shoulder blades","Pull with elbows","Control the return"], substitution: ['swimming', 'skierg', 'barbell-row', 'band-row'], unilateral: false, supportsWeighted: /weighted/i.test('rowing'), supportsAssisted: /assisted/i.test('rowing'), progression: 'load' },
